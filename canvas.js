...
var main, para;
    ...
    function init() {
            ...
            // get input boxes for parameters
            ...
            // define different colors for different object types
            twtUserColor = "red";
            tweetColor = "#1e90ff";
            twtGeoColor = "brown";
    ...
    function addParaCount(x, y, name){
    ...
    function handleClickTimeline(event){
        ...
        document.getElementById("commonfriends").style.display = "none";
        document.getElementById("commonfollowers").style.display = "none";
    ...
    function handleClickFriends(event){
        ...
        document.getElementById("commontimeline").style.display = "none";
        document.getElementById("commonfollowers").style.display = "none";
    ...
    function handleClickUser(event){
        ...
        stage.update();
        document.getElementById("commonretweet").style.display = "none";
        drawTwtUserFields(event);
    }
